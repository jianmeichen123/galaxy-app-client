...
function Node(id, pid, name, url,checkflag,checkclick, title, target, icon, iconOpen, open) {
...
dTree.prototype.add = function(id, pid, name, url, checkflag,checkclick, title, target, icon, iconOpen, open) {

	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url,checkflag,checkclick, title, target, icon, iconOpen, open);
		...
		function caBox(formId, regx ) {
			if( document.getElementById( regx ).checked ){
				...
				for (var i=0; i<form.elements.length; i++) {
					...
					if (element.name == "checkid" && element.type=='checkbox'){
						// checked next node 
