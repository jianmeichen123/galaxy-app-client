...
function Node(id, pid, name, url,checkflag,checkclick,userSelect,userSelectData,title, target, icon, iconOpen, open) {
...
dTree.prototype.add = function(id, pid, name, url, checkflag,checkclick,userSelect,userSelectData, title, target, icon, iconOpen, open) {

	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url,checkflag,checkclick,userSelect,userSelectData, title, target, icon, iconOpen, open);
