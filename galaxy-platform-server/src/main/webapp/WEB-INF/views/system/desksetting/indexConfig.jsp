     ...
     var eblockRow='<div class="eblockRow clearfix">'
          +'<div class="eblock fl">'
            +'<div class="addEblockCon addEblockCon_'+i+'">'
              +'<button class="addCircleBtn" href="tchtml/addEblockCon.html" data-btn="addEblockCon_'+i+'" data-name="选择菜单">+</button>'
            +'</div>' 
          ...
          +'<div class="eblock fl">'
            +'<div class="addEblockCon addEblockCon_'+(i+1)+'">'
              +'<button class="addCircleBtn" href="tchtml/addEblockCon.html" data-btn="addEblockCon_'+(i+1)+'" data-name="选择菜单">+</button>'
            +'</div>'
